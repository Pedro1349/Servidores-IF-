    ...
    <nav class="navbar navbar-expand-lg bg-success mb-4">
      ...
      <div class="container p-4">
        <form action="/alterarPost" method="Post">
          ...
          <label for="tag">Nova Tag</label>
          <input type="text" name="tag" id="idtag">

          <label for="descricao">Nova Descricao</label>
          <input type="text" name="descricao" id="iddescricao">              
          <br>
          <br>
          <label for="titulo">Titulo Antigo</label>
          <input type="text" name="tituloAntigo" id="idtituloAntigo">
